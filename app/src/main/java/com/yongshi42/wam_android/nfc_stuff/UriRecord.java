...
package com.yongshi42.wam_android.nfc_stuff;

import android.annotation.SuppressLint;
import static androidx.core.util.Preconditions.*;
...
public class UriRecord implements ParsedNdefRecord {
     ...
     */
        ...
        private static UriRecord parseWellKnown(NdefRecord record) {
            checkArgument(Arrays.equals(record.getType(), NdefRecord.RTD_URI));
            byte[] payload = record.getPayload();
            /*
